...
i want to create an expense splitter app, right now I want to create the front end and i want you to leave mock calls for the back end and i will create that later; here are the specs
...
Continue developing this project in the [Lovable editor](https://lovable.dev/projects/cc33f8a5-0ef9-47ae-9167-740c5940e4dc).
